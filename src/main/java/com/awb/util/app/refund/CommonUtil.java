...
public class CommonUtil {
    ...
    public static String createSign(String characterEncoding,
        ...
        sb.append("key=" + Const.SHANGHU_KEY);
    ...
    public static String httpsRequest2(String requestUrl, String requestMethod,
        ...
        FileInputStream instream = new FileInputStream(new File(
                "D:/as/apiclient_cert.p12"));
//        FileInputStream instream = new FileInputStream(new File(
//                "/home/apiclient_cert.p12"));
        try {
            keyStore.load(instream, "1494675952".toCharArray());
        } finally {
            instream.close();
        }
        ...
        SSLContext sslcontext = SSLContexts.custom()
                .loadKeyMaterial(keyStore, "1494675952".toCharArray()).build();
